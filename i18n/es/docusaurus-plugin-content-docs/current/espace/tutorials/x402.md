...
x402 payments are built on [EIP-3009](https://eips.ethereum.org/EIPS/eip-3009) (_Transfer With Authorization_), so they work with any stablecoin that implements it — and Conflux eSpace has two.
