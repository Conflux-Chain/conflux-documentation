...
keywords: [ Conflux Network, v2.4 hardfork, CIPs, base fee, transaction fee model, EIP-1559, CIP-1559, typed transactions, block gas limit, RPC 变更, BLOCKHASH opcode, BASEFEE opcode, MCOPY opcode, TLOAD opcode, TSTORE opcode, point evaluation precompile, mainnet upgrade, testnet upgrade, CIP-130, CIP-131, CIP-132, CIP-133, CIP-136, CIP-137, CIP-141, CIP-142, CIP-143, CIP-144, CIP-145 ]
tags: [ 硬分叉 ]
---
