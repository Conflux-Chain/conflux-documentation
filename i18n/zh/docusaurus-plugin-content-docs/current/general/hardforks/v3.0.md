...
- RPC 变更：
  ...
  - eSpace parity style trace RPCs updates:
    ...
    - `trace_blockSetAuth` 是Conflux特有的RPC，用于获取区块的set auth操作结果，详情请查看[trace文档](https://github.com/Conflux-Chain/conflux-rust/blob/master/docs/transaction-trace/parity-style-trace.md#trace-setauth7702)。
