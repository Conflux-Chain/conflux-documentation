...
![Can not cross space](../image/cannot-cross-space.jpg)
...
![call the `registerMetadata` method](../image/call-beacon-proxy-core.jpg)
...
![metadata](../image/fanscoin-metadata.jpg)
...
![create map token](../image/create-map-token.jpg)
...
![use cross space](../image/use-cross-space.jpg)
...
![default display](../image/default-display.png)
...
![community default display](../image/fanscoin-bridge.png)
