...
| [**Fluent Integration**](../core/build/fluent.md)| Guidance on integrating Fluent wallet into your frontend (not recommended as this article mainly focus on the low-level interfaces) | Wallet Connection, Fluent wallet |
