---
title: v2.1
keywords: [Conflux Network, v2.1 hardfork, CIPs, DAO voting, reward parameters, staking lists, BLOCKHASH opcode, PoS voting, ParamControl, internal contract, fullstate query, eth_subscribe, eth_unsubscribe, cfx_getParamsFromVote, mainnet upgrade, testnet upgrade, CIP-94, CIP-97, CIP-98, CIP-99, CIP-105]
...
CIP-94 also has introduce a new InternalContract `ParamControl` at hex address `0x0888000000000000000000000000000000000007`. This contract can be used to retrieve parameter info and participate in DAO vote.
